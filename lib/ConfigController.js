module.exports = function ConfigController(options) {
	...
	var self = this,
		...
		async = require('async'),
		ConfigSchema = require('./schemas/ConfigSchema'),
		...
		cacheOptions = {
			mode: 'server',
			expiresIn: options.secondsToCache
		},
